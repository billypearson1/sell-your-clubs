          ...
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-3">
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? 'rounded-[8px] px-4 py-3 text-sm font-semibold transition bg-[#00537E] text-white'
                    : 'rounded-[8px] px-4 py-3 text-sm font-semibold transition text-[#00243D] hover:bg-slate-100'
                }
              >
                Sell
              </NavLink>
